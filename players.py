...
if supervis:
    ...
    PLAYER_DETECTION_MODEL_PATH = '/content/sports-main/examples/soccer/data/football-player-detection.pt'
...
func_box(video_in, 'boxes.npy', start_frame=100_001, end_frame=100_001+2000)